...
const ProductDetailsScreen = () => {
  ...
  const navigateToReview = () => {
    navigation.navigate(TAB_NAVIGATION_ROOT.HOME_ROUTE.RATING, { listReview, item });
  };
      ...
      <ScrollView style={styles.viewMain}>
        ...
        <View>
          ...
          <View style={styles.ratingView}>
            ...
            <Text style={styles.reviewQuantity}>{listReview.length} reviews</Text>
          </View>
          {listReview.length > 0 ? <Review item={item} itemReview={listReview[0]} />
            : null}
        </View>
      </ScrollView>
